  ...
  return (
    <>
      ...
      <Container style="rounded-lg shadow-2xl absolute inset-10 box-border z-10 bg-white max-w-screen max-h-screen overflow-x-auto">
        {
          <>
            <ContactForm style="absolute justify-start w-[350px] top-[10%] left-[5%] hero" />
            <div className="hidden w-[50%] h-32 lg:flex flex-col justify-start items-start ml-[35%] mt-[15%] font-bold gap-4">
