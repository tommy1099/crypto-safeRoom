...
const SignupForm = () => {
  ...
  return (
    <Container style=" absolute w-[400px] h-[550px] fixed left-[5%] sm:left-[15%] md:left-[20%] lg:left-[7%] shadow-2xl p-10 flex flex-col justify-center items-start rounded-lg">
