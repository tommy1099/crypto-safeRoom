...
import FeminineCategoryCards from "./FeminineCategoryCards";
import ProductFemininePage from "./ProductFemininePage";
    ...
    <div className="">
      ...
      <div className="flex flex-col items-center pt-[10%] justify-center">
        ...
        <div className=" overflow-x-auto mt-10 md:w-[82%] h-full">
          <div
            onClick={() => navigate("/product/category/feminine/all")}
